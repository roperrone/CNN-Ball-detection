...
3. Download [dataset files](https://perso.liris.cnrs.fr/christian.wolf/teaching/deeplearning/data/train.tgz) to data/ and unzip
4. Run python split_files.py to create train and val datasets
